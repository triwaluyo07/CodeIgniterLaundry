			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<form action="<?php echo base_url().'admin/Products/add' ?>" method="post" enctype="multipart/form-data" id="form_baru">
							<div class="form-group">
								
								<label for="nama_depan">Nama Depan</label>
								<input class="form-control <?php echo form_error('nama_depan') ? 'is-invalid':'' ?>"
								 type="text" name="nama_depan" placeholder="Nama Depan" id="nama_depan"/>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama_belakang') ? 'is-invalid':'' ?>"
								 type="text" name="nama_belakang" placeholder="Nama Belakang" id="nama_belakang"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('alamat') ? 'is-invalid':'' ?>"
								 type="text" name="alamat" placeholder="Alamat" id="alamat"> </textarea>
								<div class="invalid-feedback">
							...
							<?php echo form_error('waktu') ? 'is-invalid':'' ?>>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('harga') ? 'is-invalid':'' ?>"
								 type="number" name="harga" min="0" placeholder="harga" id="harga"/>
								<div class="invalid-feedback">
